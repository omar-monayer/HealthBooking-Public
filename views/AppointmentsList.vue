...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://cqmguyqq32.execute-api.eu-north-1.amazonaws.com/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://cqmguyqq32.execute-api.eu-north-1.amazonaws.com/appointments${appointment.appointmentId}`;
